  ...
  const downloadExcel = () => {
    const worksheetData = data.map(row => {
      return {
        ...
        'Sector': row.SECTOR,
        'Approved Facility Amount (Limit)': row['APPROVED TOTAL FACILITY AMOUNT/LIMIT'],
        'Total Exposures (USD)': row['TOTAL EXPOSURES(USD)'],
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Kenya Top 5');
    XLSX.writeFile(workbook, 'KenyaTop5.xlsx');
  };
