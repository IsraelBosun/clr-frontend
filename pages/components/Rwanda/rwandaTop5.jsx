...
const RwandaTop5 = ({ data }) => {
  ...
  const columns = React.useMemo(
    () => [
      ...
      { Header: 'Total Exposures', accessor: 'OUTSTANDING BALANCE', Cell: ({ value }) => formatNumber(value) },
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Rwanda Top 5');
    XLSX.writeFile(workbook, 'RwandaTop5.xlsx');
  };
