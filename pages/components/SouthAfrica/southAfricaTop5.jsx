...
const SouthAfricaTop5 = ({ data }) => {
  ...
  const columns = React.useMemo(
    () => [
      { Header: 'Customer Name', accessor: 'CUST_ID' },
      ...
      { Header: 'IFRS', accessor: 'GROUP IFRS_CLASSIFICATION PER 31.12.2021 NPL Stage 3 ' },
      { Header: 'Classification', accessor: 'PRUDENTIAL_CLASSIFICATION- IN WORDS WATCHLIST ETC' },
    ],
    []
  );
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'SouthAfrica Top 5');
    XLSX.writeFile(workbook, 'SouthAfricaTop5.xlsx');
  };
...
export default SouthAfricaTop5;
