  ...
  const downloadExcel = () => {
    const worksheetData = data.map(row => {
      return {
        ...
        'Total Exposures (USD)': row['BANK CLASSIFICATION  AS AT TODAY '],
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Congo Top 5');
    XLSX.writeFile(workbook, 'CongoTop5.xlsx');
  };
