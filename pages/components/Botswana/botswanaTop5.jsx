  ...
  const downloadExcel = () => {
    const worksheetData = data.map(row => {
      return {
        ...
        'Total Exposures (USD)': row['CURRENT EXPOSURE (USD)'],
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Botswana Top 5');
    XLSX.writeFile(workbook, 'BotswanaTop5.xlsx');
  };
