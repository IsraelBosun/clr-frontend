...
const sectorLimits = {
  ...
  "CONTRACTORS": 11.00,
  "EDUCATION": 2.00,
  "FINANCIAL INSTITUTION": 6.00,
  "GENERAL COMMERCE": 35.00,
  "GOVERNMENT": 11.00,
  "INFORMATION & COMMUNICATION": 22.60,
  "MANUFACTURING": 0.00,
  "OIL & GAS": 49.00,
  "POWER & ENERGY": 0.00,
  "RETAIL": 25.00,
  "RETAIL SME": 17.60,
  "TRANSPORTATION & STORAGE": 14.00,
  "TRANSPORATION & STORAGE": 14.00
};

const GambiaSector = ({ data }) => {
  if (!data) {
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Gambia Sector');
    XLSX.writeFile(workbook, 'GambiaSector.xlsx');
  };
