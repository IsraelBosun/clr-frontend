...
const GambiaTop5 = ({ data }) => {
  ...
  const columns = React.useMemo(
    () => [
      ...
      { Header: 'Total Exposures (USD)', accessor: 'OUTSTANDING BALANCE', Cell: ({ value }) => formatNumber(value) },
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Gambia Top 5');
    XLSX.writeFile(workbook, 'GambiaTop5.xlsx');
  };
