...
const AngolaTop5 = ({ data }) => {
  ...
  const columns = React.useMemo(
    () => [
      ...
      { Header: 'Total Exposures (USD)', accessor: 'OUTSTANDING BALANCE \n(USD)', Cell: ({ value }) => formatNumber(value) },
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Angola Top 5');
    XLSX.writeFile(workbook, 'AngolaTop5.xlsx');
  };
