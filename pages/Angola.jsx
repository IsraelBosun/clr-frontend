...
import AngolaStage2 from "./components/Angola/angolaStage2";
import AngolaSector from "./components/Angola/angolaSector";    
...
const AngolaScreen = () => {
  ...
  const loadPersistedData = async () => {
    const querySnapshot = await getDocs(collection(db, "angolaData"));
  ...
  {/* // md:w-1/2 lg:w-3/4 xl:w-full w-96 */}
        ...
        {isTop5Open && ghanaData.top5_customers && (
          <AngolaTop5 data={ghanaData.top5_customers} />
        )}
        </div>
        ...
        {isMissedRepaymentsOpen && ghanaData.missed_repayments_data && (
          <AngolaMissedRepayment data={ghanaData.missed_repayments_data} />
        )}
        </div>
