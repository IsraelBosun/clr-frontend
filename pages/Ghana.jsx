...
const GhanaScreen = () => {
  ...
  useEffect(() => {
    console.log("Ghana Chart Data:", kenyaChartData); // Debugging log to inspect kenyaChartData
  ...
  return (
    ...
    <div className = 'flex items-center justify-center font-bold text-neutral-600 text-5xl'>Ghana's Credit Dashboard</div>
      ...
      <div className="max-w-6xl">
        {kenyaData.top5_customers && <Ghana data={kenyaData.top5_customers} />} 
      </div>
      <div className="flex flex-col items-center">
        <FileUploadButton
          title="Ghana's CLR Analyser"
