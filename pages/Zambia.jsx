...
import GhanaTop5 from "./components/Ghana/ghanaTop5";
import GhanaMissedRepayment from "./components/Ghana/ghanaMissedRepayments";
import GhanaStage2 from "./components/Ghana/ghanaStage2";
import GhanaSector from "./components/Ghana/ghanaSector";    
...
const ZambiaScreen = () => {
  ...
  const loadPersistedData = async () => {
    const querySnapshot = await getDocs(collection(db, "ghanaData"));
  ...
  const handleDataLoaded = async (data) => {
    ...
    await addDoc(collection(db, "ghanaData"), relevantData);
  };
  ...
  {/* // md:w-1/2 lg:w-3/4 xl:w-full w-96 */}
        ...
        {isMissedRepaymentsOpen && ghanaData.missed_repayments_data && (
          <GhanaMissedRepayment data={ghanaData.missed_repayments_data} />
        )}
        </div>
        ...
        {isStage2Open && ghanaData.top_20_stage2 && (
          <GhanaStage2 data={ghanaData.top_20_stage2} />
        )}
        </div>
