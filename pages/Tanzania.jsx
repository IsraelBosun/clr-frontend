...
import TanzaniaStage2 from "./components/Tanzania/tanzaniaStage2";
import TanzaniaSector from "./components/Tanzania/tanzaniaSector";    
...
const GhanaScreen = () => {
  ...
  const loadPersistedData = async () => {
    const querySnapshot = await getDocs(collection(db, "tanzaniaData"));
  ...
  {/* // md:w-1/2 lg:w-3/4 xl:w-full w-96 */}
        ...
        {isTop5Open && ghanaData.top5_customers && (
          <TanzaniaTop5 data={ghanaData.top5_customers} />
        )}
        </div>
        ...
        {isMissedRepaymentsOpen && ghanaData.missed_repayments_data && (
          <TanzaniaMissedRepayment data={ghanaData.missed_repayments_data} />
        )}
        </div>
        ...
        {isStage2Open && ghanaData.top_20_stage2 && (
          <TanzaniaStage2 data={ghanaData.top_20_stage2} />
        )}
        </div>
        ...
        {isSectorOpen && ghanaData.sector_data && (
          <TanzaniaSector data={ghanaData.sector_data} />
        )}
      ...
      <div className='mt-8'>
        <FileUploadButton
          ...
          url="https://clr-1.onrender.com/tanzania"
        />
      </div>
    </div>
  );
