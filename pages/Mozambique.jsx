...
import MozambiqueTop5 from "./components/Mozambique/mozambiqueTop5";
import MozambiqueMissedRepayment from "./components/Mozambique/mozambiqueMissedRepayments";
import MozambiqueStage2 from "./components/Mozambique/mozambiqueStage2";
import MozambiqueSector from "./components/Mozambique/mozambiqueSector";    
...
const MozambiqueScreen = () => {
  ...
  const loadPersistedData = async () => {
    const querySnapshot = await getDocs(collection(db, "mozambiqueData"));
  ...
  const handleDataLoaded = async (data) => {
    ...
    await setDoc(doc(db, "mozambiqueData", timestamp), relevantData);
  };
  ...
  {/* // md:w-1/2 lg:w-3/4 xl:w-full w-96 */}
        ...
        {isTop5Open && ghanaData.top5_customers && (
          <MozambiqueTop5 data={ghanaData.top5_customers} />
        )}
        </div>
        ...
        {isMissedRepaymentsOpen && ghanaData.missed_repayments_data && (
          <MozambiqueMissedRepayment data={ghanaData.missed_repayments_data} />
        )}
        </div> */}
        ...
        {isStage2Open && ghanaData.top_20_stage2 && (
          <MozambiqueStage2 data={ghanaData.top_20_stage2} />
        )}
        </div>
        ...
        {isSectorOpen && ghanaData.sector_data && (
          <MozambiqueSector data={ghanaData.sector_data} />
        )}
      ...
      <div className='mt-8'>
        <FileUploadButton
          ...
          url="https://clr-1.onrender.com/mozambique"
        />
      </div>
    </div>
  );
...
export default MozambiqueScreen;
